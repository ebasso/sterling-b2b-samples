...
| [code-list-editor-web](business-process/code-list-editor-web/README.md) | The UI to manipulate Code List is poor. This solution helps to search and update codes in Code List |
...
| [filegateway-advanced-search-for-partners](filegateway-scenarios/filegateway-advanced-search-for-partners/README.md) | Web based solution to do Advanced  Search for File Gateway' Partners |
